...
void
NN1::forward(double* I)
{
  upper->forward(I);
}

void
NN1::forward(int* I1,double* I2)
{
  upper->forward(I1,I2);
}

void
NN1::forward(double* I1,double* I2)
{
  upper->forward(I1,I2);
}
...
void
NN1::gradient(int* I, double* t)
{
  upper->gradient(I);
}
void
NN1::gradient(double* I, double* t)
{
  upper->gradient(I);
}
void
NN1::gradient(int* I1,double* I2, double* t)
{
  upper->gradient(I1,I2);
}
void
NN1::gradient(double* I1,double* I2, double* t)
{
  upper->gradient(I1,I2);
}
...
void
NN1::updateWeights(double epsilon)
{
  upper->updateWeights(epsilon);
}

void
NN1::updateWeightsL1(double epsilon)
{
  upper->updateWeightsL1(epsilon);
}

void
NN1::updateWeightsClipped(double epsilon)
{
  upper->updateWeightsClipped(epsilon);
}

void
NN1::initWeights(int seed)
{
