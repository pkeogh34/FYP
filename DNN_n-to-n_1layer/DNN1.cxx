...
DNN1::DNN1(int the_NU, int the_NY, int the_NLayers, int* the_Ht, int the_NHi, int the_Hi, int the_gamma, int the_context, int the_doubleo) :
NU(the_NU), NY(the_NY), NLayers(the_NLayers), NHi(the_NHi), Hi(the_Hi), gamma(the_gamma), context(the_context), doubleo(the_doubleo)
{
...
DNN1::DNN1(istream& is, int the_NU, int the_NY, int the_NLayers,int* the_Ht, int the_NHi, int the_Hi, int the_gamma, int the_context, int the_doubleo) :
NU(the_NU), NY(the_NY), NLayers(the_NLayers), NHi(the_NHi), Hi(the_Hi), gamma(the_gamma), context(the_context), doubleo(the_doubleo)
{
...
cout << dummynet->get_NI() << " " << dummynet->get_NIr() << " " << " " << dummynet->get_NO() << "\n" << flush;
...
void 
DNN1::I_T(double* seq, int t, int length){
double I[8196];
int c,h;
...
void 
DNN1::I_T(double* seq, int t1, int t2, int length){
double I[8196];
int c,h;
double*X;
NNt* tempo = new NNt(NetI);
...
void 
DNN1::I_T(int* seq, int t, int length){
int I[8196];
int c,h;
...
void 
DNN1::I_T(int* seq, int t1, int t2, int length){
int I[8196];
int c,h;
double*X;
NNt* tempo = new NNt(NetI);
...
void 
DNN1::T_T(int Lay, int t, int length){
double I[8196];
int c,h;
...
void 
DNN1::T_T(int Lay, int t1, int t2, int length){
double I[8196];
int c,h;
double*X;
NNt1* tempo = new NNt1(NetT[Lay]);
...
void 
DNN1::T_O(int t1, int t2, int length){
double*X;
NN1*tempo = new NN1(NetO);
...
void
DNN1::make_global_input(int length) {
int t;
...
void 
DNN1::propagate(double* seq, int length) {
int t,l;
...
void 
DNN1::propagate(int* seq, int length) {
int t,l;
int chunk = length/NTH;
if (chunk<1) chunk=1;
...
void 
DNN1::I_Tbp(double* seq, int t, int length) {
double I[8196];
int c,h;
...
void 
DNN1::I_Tbp(double* seq, int t1, int t2, int length) {
double I[8196];
int c,h;
double*X;
NNt* tempo = new NNt(NetI);
...
void 
DNN1::I_Tbp(int* seq, int t, int length) {
int I[8196];
int c,h;
...
void 
DNN1::I_Tbp(int* seq, int t1, int t2, int length) {
int I[8196];
int c,h;
double*X;
NNt* tempo = new NNt(NetI);
...
void 
DNN1::T_Tbp(int Lay, int t, int length) {
double I[8196];
int c,h;
...
void 
DNN1::T_Tbp(int Lay, int t1, int t2, int length) {
double I[8196];
int c,h;
double*X;
NNt1* tempo = new NNt1(NetT[Lay]);
...
void 
DNN1::T_Obp(double* target, int t, int length) {
double*X;
NN1* tempo = new NN1(NetO);
tempo->forward(X,Hcache[NLayers][t]);
for (int y=0;y<NY;y++) {
...
void 
DNN1::T_Obp(double** target, int t1, int t2, int length) {
double*X;
NN1* tempo = new NN1(NetO);
double errloc=0;
...
void 
DNN1::T_Obp(int target, int t, int length) {
...
void 
DNN1::T_Obp(int* target, int t1, int t2, int length) {
...
void
DNN1::make_global_backprop(int length) {
...
void
DNN1::extimation(double *seq, int* y, int length, int backp) {
...
void
DNN1::extimation(int *seq, int* y, int length, int backp) {
...
void
DNN1::extimation(double *seq, double* y, int length, int backp) {
...
void
DNN1::extimation(int *seq, double* y, int length, int backp) {
...
void
DNN1::Feed(double* seq, int length) {
int t;
...
void
DNN1::predict(double* seq, int length) {

Feed(seq,length);
}

void
DNN1::predict(int* seq, int length) {
