...
Model::Model(int the_NU, int the_NY, int the_NLayers, int *the_Ht, int the_NHi, int the_Hi,
			 int the_gamma, int the_context, double *the_Thresholds) : NU(the_NU), NY(the_NY), NLayers(the_NLayers), NHi(the_NHi), Hi(the_Hi), gamma(the_gamma), context(the_context) {
...
void Model::randomize_top(int seed) {
